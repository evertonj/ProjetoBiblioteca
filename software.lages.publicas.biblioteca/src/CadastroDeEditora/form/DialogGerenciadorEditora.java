...
import CadastroDeObra.form.*;

/**
 *
 * @author Alex
 */
public class DialogGerenciadorEditora extends javax.swing.JDialog {

    /**
     * Creates new form FrmObra
     */
    public DialogGerenciadorEditora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btNovaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovaActionPerformed
         FrmCadastroDeEditora cadastroDeEditora = new FrmCadastroDeEditora(new javax.swing.JFrame(), true);
        cadastroDeEditora.setVisible(true);
    ...
    private void btAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarActionPerformed
        FrmAtualizarEditora atualizarEditora = new FrmAtualizarEditora(new javax.swing.JFrame(), true);
       atualizarEditora.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogGerenciadorEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                 DialogGerenciadorEditora dialog = new DialogGerenciadorEditora(new javax.swing.JFrame(), true);
