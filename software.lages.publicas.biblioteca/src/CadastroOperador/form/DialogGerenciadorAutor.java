 ...
 * @author Alex
 */
public class DialogGerenciadorAutor extends javax.swing.JDialog {

    /**
     * Creates new form FrmObra
     */
    public DialogGerenciadorAutor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogGerenciadorAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                 DialogGerenciadorAutor dialog = new DialogGerenciadorAutor(new javax.swing.JFrame(), true);
