 ...
 * @author Alex
 */
public class DialogGerenciadorOperador extends javax.swing.JDialog {

    /**
     * Creates new form FrmObra
     */
    public DialogGerenciadorOperador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogGerenciadorOperador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                 DialogGerenciadorOperador dialog = new DialogGerenciadorOperador(new javax.swing.JFrame(), true);
