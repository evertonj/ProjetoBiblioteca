 ...
 * @author Thiago
 */
public class FrmBuscaAssunto extends javax.swing.JDialog {

    /**
     * Creates new form FrmBuscaAssunto
     */
    public FrmBuscaAssunto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        refreshTable();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscaAssunto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmBuscaAssunto dialog = new FrmBuscaAssunto(new javax.swing.JFrame(), true);
