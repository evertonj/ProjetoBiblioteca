 ...
 * @author Thiago
 */
public class DialogRelatorioEditora extends javax.swing.JDialog {

    /**
     * Creates new form DialogRelatorio
     */
    public DialogRelatorioEditora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nome", "Cidade" }));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
         try {
            ...
            if (relatorio.defineStringConnect("Editoras"+cbTipo.getSelectedItem().toString())) {
                chamaRelatorio();
                this.setModal(false);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogRelatorioEditora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogRelatorioEditora dialog = new DialogRelatorioEditora(new javax.swing.JFrame(), true);
