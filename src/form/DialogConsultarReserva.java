 ...
 * @author Alex
 */
public class DialogConsultarReserva extends javax.swing.JDialog {
     ...
     */
    public DialogConsultarReserva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consultar reserva por:");
    ...
    private void tbAtualizarReservaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAtualizarReservaMouseClicked
        try {
            ...
            if (rowIndex == -1) {
                JOptionPane.showMessageDialog(this, "Selecione a Reserva a ser Atualizada!!!");
                return;
            }
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogConsultarReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogConsultarReserva dialog = new DialogConsultarReserva(new javax.swing.JFrame(), true);
