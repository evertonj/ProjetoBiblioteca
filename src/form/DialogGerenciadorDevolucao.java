 ...
 * @author Alex
 */
public class DialogGerenciadorDevolucao extends javax.swing.JDialog {

    /**
     * Creates new form DialogAssunto
     */
    public DialogGerenciadorDevolucao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Gerenciador de Devolução");
        setResizable(false);
    ...
    private void btConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConsultarActionPerformed
        new DialogConsultarDevolucao(new javax.swing.JFrame(), true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogGerenciadorDevolucao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                 DialogGerenciadorDevolucao dialog = new DialogGerenciadorDevolucao(new javax.swing.JFrame(), true);
